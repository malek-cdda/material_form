      ...
      <Box
        ...
        <motion.div
          ...
          <Typography
            variant="h1"
            sx={{
              mt: [8, null, 6], // Responsive margin top
              textAlign: "center",
              fontSize: ["1.25rem", null, "1.5rem"], // Responsive font size
              fontWeight: "800", // font-extrabold
              lineHeight: ["1.125", null, "1"], // Responsive line height
        ...
        <div
          ...
          <Link href="/apps/dashboards/project">Back to Dashboard</Link>
        </div>
      </Box>
    </Box>
  );
